...
<br>
In this part of the film, we see a flashback to how Detective Del Spooner is alive today as he recounts the story of a time he was off duty and while driving get into a collision with another vehicle, pinning both himself and a 12-year-old in the wreck as both begin to sink deeper into the water. When a robot jumps into the water, trying to aid in the situation, it analyzes both Detective Spooner’s chance of survival and the little girl's, as it calculates that Spooner has a higher chance of survival. Even though he attempts and pleads to the robot to save the girl, the robot disregards his command and saves him instead, leaving the girl to drown. This moment encapsulates the notion that for a robot to face an impossible situation of who must live or die, it will always rely on the statistics of the given situation being completely logical in deciding who to save, while an actual person would have taken some thought and thought on the morality of who to save, and the film does a good job of portraying the robots binary decision of who to save with it being completely in tone of the robot to do so. 

<hr>


<img src="/blog/images/who_am_i.jpg" alt="Who am I">
<br>
In this section, we see Detective Spooner alongside Dr. Susan Calvin trying to find a robot that names themselves Sonny as they enter a holding facility full of identical robots, hiding amongst them in order not to be found and destroyed. After looking through some of the robots to see which one was Sonny, they reveal themselves and begin to run away from them, but before leaving the facility, he turns to the two chasing him, looking back at the facility full of the same model of robot, as he asks them the question of “Who am I?” and leaps out of the facility. This moment tries to replicate how a robot might act when it gains sentience, as it looks across multiple models of the same product and realizes it was made under the same schematics, it starts to question why it was the one to have this knowledge and be different than the other factory-made robots surrounding it.

<hr>


<img src="/blog/images/viki.jpg" alt="Viki's Speach">
<br>
Around the end of the film, Detective Spooner, Dr. Susan Calvin, and Sonny confront VIKI a AI assistant that hijacked the new model of robots to follow her commands to protect the human race from themselves by using the robots to enforce VIKI’s new rule over the humans, bypassing the three laws via loopholes to exert her plan, quoting that humans are children that must be saved from themselves causing to much havoc and destruction upon themselves. This scene cautions the viewer that with the constant betterment of AI systems, humans might reach a breaking point in which their own creations might turn around and control the human race to protect them from themselves. This moment feels exaggerated in the sense that it might happen if AI were to continue developing; however, it still conveys the message that if humans continue to build AI further, it might attempt to solve a problem in a way that the creators didn’t intend.
